...
-- 初始化数据：插入默认协议（示例）
INSERT IGNORE INTO protocols (protocol_id, name, description, category, logo_url, website_url, risk_level, is_active, supported_chains) VALUES
('aave', 'Aave', '开源非托管流动性协议', 'lending', 'https://app.aave.com/favicon.ico', 'https://aave.com', 2, TRUE, '[1, 137, 42161]'),
('compound', 'Compound', '算法货币市场协议', 'lending', 'https://compound.finance/favicon.ico', 'https://compound.finance', 2, TRUE, '[1]'),
('uniswap', 'Uniswap', '去中心化交易协议', 'dex', 'https://app.uniswap.org/favicon.ico', 'https://uniswap.org', 2, TRUE, '[1, 137, 42161, 10]'),
('curve', 'Curve Finance', '稳定币兑换协议